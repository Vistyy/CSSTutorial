function getTutorial() {
  ...
  const currentTutorial = urlParams.get("tutorial");
...
window.onload = () => {
  ...
  //   console.log(Object.keys({ templateAnimations })[0]);
  tutorialArray.forEach((el) => {
    // console.log(Object.keys(el)[0].toString());
    if (el.includes(tutorial)) {
      container.insertAdjacentHTML("beforeend", eval(el));
    }
  });
};
